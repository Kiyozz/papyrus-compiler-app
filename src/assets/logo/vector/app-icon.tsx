...
const AppIcon: React.FC<Props> = ({ children, ...props }) => (
  <SvgIcon {...props}>
    <g>
      <g>
        <g>
          <g transform="matrix(0.023261376487247822,0,0,0.023261376487247822,-53.75114056074676,-53.75114336268325) ">
            <g transform="matrix(11.07810326687287,0,0,11.07810326687287,149.97218195081322,154.81885626911432) " fill="currentColor">
