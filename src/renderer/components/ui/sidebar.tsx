    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            'group/sidebar-wrapper flex min-h-(--page-height) w-full has-data-[variant=inset]:bg-sidebar',
            className,
          )}
          {...props}
        >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'fixed inset-y-0 z-10 hidden h-(--sidebar-aside-height) w-(--sidebar-width) flex-col justify-end self-end transition-[left,right,width] duration-200 ease-linear md:flex',
          side === 'left'
...
function SidebarHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        'drag group-data-[collapsible=icon]:!p-0 flex items-center gap-2 p-2 transition-[padding] duration-200 ease-linear',
        className,
      )}
      {...props}
    />
