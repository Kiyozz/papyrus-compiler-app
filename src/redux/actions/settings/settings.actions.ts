...
export const actionDetectBadInstallation = createAction<{ gamePath: string, gameType: Games, isUsingMo2: boolean, mo2Path: string }>(CONSTANTS.APP_SETTINGS_DETECT_BAD_INSTALLATION)
