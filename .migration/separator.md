...
- `src/renderer/components/ui/separator.tsx` - `radix-ui` Separator ->
  `@base-ui/react/separator`; props typed `SeparatorPrimitive.Props`. Classes
  unchanged.
- Leftover scan clean.
...
1. Check separators in dropdown menus and in the sidebar still draw a 1px
   line at the right orientation.
